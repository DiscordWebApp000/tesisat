          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              {allTags.map((tag) => (
                ...
                >
                  #{tag} ({haberler.filter(haber => haber.tags && haber.tags.includes(tag)).length})
                </button>
              ))}
            </div>
          </div>
            ...
            <div key={haber.id} className="mb-16 bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-6">{haber.description}</p>
            ...
            {otherNews.map((haber) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link href={`/haberler/${haber.id}`}>
                    <h3 className="font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors cursor-pointer">
                      {haber.title}
                    </h3>
                  </Link>
                  {haber.subtitle && (
