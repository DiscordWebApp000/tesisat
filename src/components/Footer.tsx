    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Sütun 1: Şirket */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-white border-b-2 border-amber-500 pb-2">
              Şirket
            </h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/hizmetlerimiz" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Hizmetlerimiz
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-pink-600 rounded-full flex items-center justify-center text-white transition-all duration-300"
                title="Instagram"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="/iletisim" 
                className="w-10 h-10 bg-gray-800 hover:bg-amber-600 rounded-full flex items-center justify-center text-white transition-all duration-300"
                title="İletişim"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-gray-400 text-sm">Profesyonel Tesisat Hizmetleri</span>
            </div>
